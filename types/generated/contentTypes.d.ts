...
export interface ApiPlayerPlayer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    agentReportedAcceleration: Schema.Attribute.Float;
    agentReportedAgility: Schema.Attribute.Float;
    agentReportedBallControl: Schema.Attribute.Float;
    agentReportedDefensiveDuels: Schema.Attribute.Float;
    agentReportedFinishing: Schema.Attribute.Float;
    agentReportedHeading: Schema.Attribute.Float;
    agentReportedPassing: Schema.Attribute.Float;
    ...
    birthDate: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.Private;
    club: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Free Agent'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    darkInfoCard1Content: Schema.Attribute.String;
    darkInfoCard1Title: Schema.Attribute.String;
    darkInfoCard1Url: Schema.Attribute.String;
    darkInfoCard2Content: Schema.Attribute.String;
    darkInfoCard2Title: Schema.Attribute.String;
    darkInfoCard2Url: Schema.Attribute.String;
    darkInfoCard3Content: Schema.Attribute.String;
    darkInfoCard3Title: Schema.Attribute.String;
    darkInfoCard3Url: Schema.Attribute.String;
    ...
    secondaryPosition: Schema.Attribute.String;
    slug: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    smallInfoCard1Content: Schema.Attribute.String;
    smallInfoCard1Highlighted: Schema.Attribute.Boolean;
    smallInfoCard1Title: Schema.Attribute.String;
    smallInfoCard1Url: Schema.Attribute.String;
    smallInfoCard2Content: Schema.Attribute.String;
    smallInfoCard2Highlighted: Schema.Attribute.Boolean;
    smallInfoCard2Title: Schema.Attribute.String;
    smallInfoCard2Url: Schema.Attribute.String;
    smallInfoCard3Content: Schema.Attribute.String;
    smallInfoCard3Highlighted: Schema.Attribute.Boolean;
    smallInfoCard3Title: Schema.Attribute.String;
    smallInfoCard3Url: Schema.Attribute.String;
    smallInfoCard4Content: Schema.Attribute.String;
    smallInfoCard4Highlighted: Schema.Attribute.Boolean;
    smallInfoCard4Title: Schema.Attribute.String;
    smallInfoCard4Url: Schema.Attribute.String;
    smallInfoCard5Content: Schema.Attribute.String;
    smallInfoCard5Highlighted: Schema.Attribute.Boolean;
    smallInfoCard5Title: Schema.Attribute.String;
    smallInfoCard5Url: Schema.Attribute.String;
    smallInfoCard6Content: Schema.Attribute.String;
